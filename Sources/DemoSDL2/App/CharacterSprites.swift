...
struct CharacterSprites {
    static func load(format: SDL_PixelFormatEnum.RawValue, sizedAt size: (x: Float, y: Float) = (x: 32, y: 32), into renderer: Renderer?, resourceURL sourceURL: URL = Bundle.main.resourceURL!, atlasName: String) throws -> [[Texture]] {
